...
\definetitlestyle{FilledWithBottomLine}{
    width=\paperwidth, roundedcorners=0, linewidth=0pt, innersep=0cm,
    titletotopverticalspace=0mm, titletoblockverticalspace=15mm,
    titlegraphictotitledistance=5pt
}{
...
\renewcommand\TP@maketitle{%
    ...
    \begin{minipage}{0.75\linewidth}
        ...
        {\fontsize{2.5em}{1em} \bfseries \@title \par}
        % {\Huge \bfseries \@title \par}
        \vspace*{1em}
        {\huge \@author \par}
        \vspace*{1em}
        {\Large \Advisor~|~\@institute \par}
        % \vspace*{0.5em}
        % {\large \@institute}
    \end{minipage}%
    % \vspace{40pt}
